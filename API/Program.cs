...
builder.Services.AddDbContext<StoreContext>(option => option.UseSqlServer(builder.Configuration.GetConnectionString("MyConn")));
...
{
    Logger.LogError(ex, "Error occured while seeding process");
}
